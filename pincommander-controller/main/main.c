...
// on esp32-s3 - GPIO 1, GPIO2 (Nothing), and GPIO 20, GPIO 19 (causes reboot when grounded?), GPIO 48 appears to be connected to NEOPIXEL don't work.
...
uint32_t buttons[] = {GAMEPAD_BUTTON_0, GAMEPAD_BUTTON_1, GAMEPAD_BUTTON_2, GAMEPAD_BUTTON_3, GAMEPAD_BUTTON_4, GAMEPAD_BUTTON_5, GAMEPAD_BUTTON_6, GAMEPAD_BUTTON_7,
                      ...
                      GAMEPAD_BUTTON_17, GAMEPAD_BUTTON_18, GAMEPAD_BUTTON_19, GAMEPAD_BUTTON_20};
